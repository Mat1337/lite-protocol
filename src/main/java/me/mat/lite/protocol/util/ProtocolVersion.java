...
// From: https://github.com/funkemunky/Atlas/blob/master/AtlasParent/Atlas/src/main/java/cc/funkemunky/api/tinyprotocol/api/ProtocolVersion.java
...
public enum ProtocolVersion {
    ...
    @Getter
    private final static ProtocolVersion gameVersion = fetchGameVersion();
    ...
    private static ProtocolVersion fetchGameVersion() {
        for (ProtocolVersion version : values()) {
            if (version.getServerVersion() != null && version.getServerVersion().equals(ReflectionUtil.VERSION))
                return version;
        }
        return UNKNOWN;
    }
